...
As I [previously wrote about](/blog/20240627-overcoming-security-architecture-challenges-the-promise-of-ai/), doing security architecture work is slow and difficult. AI presents great opportunities to increase the speed and, dare I say, ease at which the work can be done. It might be able to lower the barrier of entry for a new and inexperienced practitioner, and enable an experienced practitioner to be faster and better.
