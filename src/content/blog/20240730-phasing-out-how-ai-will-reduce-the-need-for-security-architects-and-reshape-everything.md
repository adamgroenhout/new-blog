...
![Imgur](https://i.imgur.com/qQ82naA.png)
...
As I [previously wrote about](https://www.adamgroenhout.com/overcoming-security-architecture-challenges-the-promise-of-ai/), doing security architecture work is slow and difficult. AI presents great opportunities to increase the speed and, dare I say, ease at which the work can be done. It might be able to lower the barrier of entry for a new and inexperienced practitioner, and enable an experienced practitioner to be faster and better.
