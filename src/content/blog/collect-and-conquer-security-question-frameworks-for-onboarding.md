...
![Imgur](https://i.imgur.com/5EQ3XGM.png)
...
The first group leverages existing frameworks: The [Baldrige Cybersecurity Excellence Builder (BCEB)](https://www.nist.gov/baldrige/products-services/baldrige-cybersecurity-initiative) and the [NIST Cybersecurity Framework (CSF)](https://www.nist.gov/cyberframework). The BCEB offers pre-structured questions designed to extract pertinent information. This post won't repeat the full list but will provide a section as an example of their quality.
...
The following is just one section of exemplary questions, among many. The full list of questions can be found [here](https://www.nist.gov/document/baldrigecybersecurityexcellencebuilder11questionsxlsx).
